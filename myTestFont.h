...
namespace myTestFont
{
    const uint8_t data[] =
    {
			...
			0xA8, 0x98, 0x10, 0xFE, 0x82, 0xFE, 0x82, 0xFE, 0x10, 0x10, 0x08, 0x10, 0x20, 0x10, 0x04, 0x0A,
			0x04, 0xF8, 0x8C, 0x8E, 0x8C, 0xF8, 0x54, 0x38, 0x6C, 0x38, 0x54, 0xE0, 0xBE, 0xE0, 0x70, 0x88,
			0x88, 0xF8, 0x90, 0xFE, 0x4A, 0x4A, 0x34, 0x0C, 0x50, 0xA0, 0x50, 0x0C, 0xC0, 0xB0, 0x98, 0xB0,
			0xC0, 0x98, 0xE4, 0x02, 0x02, 0xE4, 0x98, 0x1C, 0x20, 0xF8, 0x24, 0x18, 0x08, 0xF8, 0x08, 0xF8,
			0x08, 0x10, 0x08, 0x78, 0x88
    };
    const uint16_t offsets[] =
    {
			...
			0x161, 0x166, 0x16B, 0x16E, 0x173, 0x177, 0x17C, 0x181, 0x187, 0x18C, 0x191
    };
    const uint8_t sizes[] =
    {
			...
			0x04, 0x04, 0x03, 0x04, 0x03, 0x04, 0x05, 0x05, 0x05, 0x04, 0x04, 0x03, 0x01, 0x03, 0x05, 0x03,
			0x05, 0x05, 0x03, 0x05, 0x04, 0x05, 0x05, 0x06, 0x05, 0x05, 0x04
    };
